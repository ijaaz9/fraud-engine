...
class VelocityRuleTest {
    ...
    void setUp() {
        ...
        properties.getVelocity().setThreshold(10);
        properties.getVelocity().setWindowSeconds(300L);
        properties.getVelocity().setScore(40);
        rule = new VelocityRule(velocityStore, properties);
    }
    @Test
